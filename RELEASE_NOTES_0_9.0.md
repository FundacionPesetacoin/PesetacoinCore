# Pesetacoin Core 0.9.0

Pesetacoin Core 0.9.0 is primarily a bugfix release, bringing Pesetacoin Core in
line with Bitcoin 0.9.3. Pesetacoin Core 0.9.0 also adds in support for printing
paper wallets.
...
## Pesetacoin Core Release Notes

* Translation improvements and corrections
* Disable Transifex based translation process (not used by Pesetacoin Core)
* Add checkpoints around AuxPoW switchover block (371,337)
* Disable connections from pre-1.8 Pesetacoin Core clients
* Use HTTPS with pesetacoinchain.info
...
There is a known issue with quantities in JSON used by the RPC interface (https://github.com/pesetacoin/pesetacoin/issues/134).
...
This only affects values significantly below 1 Pesetacoin, however merchants may wish to round to
the nearest Pesetacoin on all transactions for now.

## Credits

Listed in strictly alphabetical order, using name listed in Github. This
includes those whose contributions to Bitcoin Core have been merged
into Pesetacoin Core:
