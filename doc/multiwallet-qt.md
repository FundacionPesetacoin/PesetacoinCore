...
In order to support loading of multiple wallets in pesetacoin-qt, a few changes in the UI architecture will be needed.
...
Finally, two new headers and source files will have to be added to pesetacoin-qt.pro.
...
----------------------
bitcoin.cpp is the entry point into pesetacoin-qt, and as such, will require some minor modifications to provide hooks for
