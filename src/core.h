...
// PesetaCoin aux chain ID = 0x0047 (71)
static const int AUXPOW_CHAIN_ID = 0x0047;
static const int AUXPOW_START_MAINNET = 32086;
static const int AUXPOW_START_TESTNET = 50;

/** No amount larger than this (in satoshi) is valid */
static const int64_t MAX_MONEY = 166386000 * COIN; // Pesetacoin: maximum of 166386000 coins
