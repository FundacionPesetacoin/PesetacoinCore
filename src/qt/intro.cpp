...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Pesetacoin"),
     ...
     * override -datadir in the pesetacoin.conf file in the default data directory
     * (to be consistent with pesetacoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
