...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MPTC: return QString("Mega-Pesetacoin (1,000,000 PTC)");
    case kPTC: return QString("Kilo-Pesetacoin (1000 PTC)");
    case PTC: return QString("Pesetacoin");
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case MPTC: return Q_INT64_C(100000000000000);
    case kPTC: return Q_INT64_C(100000000000);
    case PTC:  return Q_INT64_C(100000000);
...
qint64 BitcoinUnits::maxAmount(int unit)
{
    switch(unit)
    {
    case MPTC: return Q_INT64_C(900000);
    case kPTC: return Q_INT64_C(900000000);
    case PTC:  return Q_INT64_C(900000000000);    //less than the coin supply until the year 2170
...
int BitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case MPTC: return 6;  // 900,000 (# digits, without commas)
    case kPTC: return 9;  // 900,000,000
    case PTC:  return 12; // 900,000,000,000
