...
public:
    CMainParams() {
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1388528588;
        genesis.nBits    = 0x1e0ffff0;
        genesis.nNonce   = 2151022;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0xedfe5830b53251bfff733600b1cd5c192e761c011b055f07924634818c906438"));
        assert(genesis.hashMerkleRoot == uint256("0xd2a85c7a8606d7c234b366bf831d37d71a2a061f0e95ff1246fa19a80a1f5a16"));

        vSeeds.push_back(CDNSSeedData("pesetacoin.info", "dnsseed.pesetacoin.info"));
        vSeeds.push_back(CDNSSeedData("pesetachain.info", "nodos.pesetachain.info"));
...
public:
    CTestNetParams() {
        ...
        genesis.nTime = 1388512432;
        genesis.nNonce = 1358256;
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x523f8a9f38bb5998df20870d8e306a15e75e60935ee37b66df0fd36584a0e48a"));

        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("pesetachain.info", "test-seed.pesetachain.info"));
