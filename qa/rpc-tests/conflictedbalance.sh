...
# Copyright (c) 2014 The Pesetacoin Core developers
...
BITCOIND=${1}/pesetacoind
CLI=${1}/pesetacoin-cli
...
# B1 should still be able to spend 1000000 (-1 PTC fee for the successful transaction), because D is conflicted
